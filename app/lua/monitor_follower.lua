...
return rfsm.state {
    ...
    rfsm.trans{ src = 'Wait_first_request', tgt = 'FAILED', pn = 0, events = {"e_timeout"} },
    rfsm.trans{ src = 'Wait_first_target', tgt = 'Following', pn = 0, events = {"e_reply_target_found"} },
    rfsm.trans{ src = 'Wait_valid_target', tgt = 'FAILED', pn = 0, events = {"e_timeout"} },
    ...
    rfsm.trans{ src = 'Wait_navigation_request', tgt = 'FAILED', pn = 0, events = {"e_timeout"} },
    rfsm.trans{ src = 'Wait_help_request', tgt = 'Wait_for_help', pn = 0, events = {"e_req_help"} },
    rfsm.trans{ src = 'Wait_help_request', tgt = 'FAILED', pn = 0, events = {"e_timeout"} },
    ...
    rfsm.trans{ src = 'Wait_lookUp_req', tgt = 'FAILED', pn = 0, events = {"e_timeout"} },
    ...
    rfsm.trans{ src = 'Following', tgt = 'FAILED', pn = 0, events = {"e_timeout"} },
